    ...
    return (
        <>
            <div className="login-body container-fluid">
                <svg className='upper-svg-vector' width="438" height="338" viewBox="0 0 438 338" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className='lower-svg-vector' width="1540" height="521" viewBox="0 0 1500 521" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="col-12" style={{ marginTop: '30px', textAlign: 'center' }}>
                        ...
                        <Form onSubmit={handleSubmit} className="mb-3">
                            ...
                            <div className='row' style={{ textAlign: 'center' }}>
                                <div className="col-6 forget-password"><Link to="/changePassword" style={{ textDecoration: 'none', color: '#008FE0' }}>Forgot Password</Link></div>
                                <div className="col-md-4 col-6 login-button">
